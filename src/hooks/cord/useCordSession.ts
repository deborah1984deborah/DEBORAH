...
export const useCordSession = (currentStoryId: string | undefined, content: string, triggerSave: () => string | null | void, lang?: 'ja' | 'en') => {
    ...
    const addMessage = (role: 'user' | 'ai' | 'system' | 'function', msgContent: string, sessionIdOverride?: string, functionCall?: any, rawParts?: any[], thoughtSummary?: string, isAutoGenerated?: boolean) => {
