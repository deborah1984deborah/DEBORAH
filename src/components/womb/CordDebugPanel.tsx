    ...
    return createPortal(
        <div
            ...
            style={{
                ...
                border: '1px solid rgba(56, 189, 248, 0.4)', // Cyan-400 border (CORD color)
                borderRadius: '8px',
                padding: '1rem',
                color: '#e2e8f0', // Slate 200
                zIndex: isActive ? 9999 : 9997,
            ...
            <h3 style={{ margin: 0, color: '#38bdf8', fontSize: '1rem', borderBottom: '1px solid rgba(56, 189, 248, 0.2)', paddingBottom: '0.5rem' }}>
                CORD DEV TOOLS
            </h3>
